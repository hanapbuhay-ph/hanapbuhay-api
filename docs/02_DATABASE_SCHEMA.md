...
$barangays = [
    ['name' => 'Alapuyan',     'latitude' => 9.9612, 'longitude' => 124.3701],
    ['name' => 'Badiang',      'latitude' => 9.9501, 'longitude' => 124.3612],
    ['name' => 'Bakilid',      'latitude' => 9.9423, 'longitude' => 124.3534],
    ['name' => 'Balbalan',     'latitude' => 9.9678, 'longitude' => 124.3789],
    ['name' => 'Baud',         'latitude' => 9.9389, 'longitude' => 124.3456],
    ['name' => 'Biabas',       'latitude' => 9.9534, 'longitude' => 124.3623],
    ['name' => 'Budbud',       'latitude' => 9.9612, 'longitude' => 124.3812],
    ['name' => 'Bulilit',      'latitude' => 9.9445, 'longitude' => 124.3589],
    ['name' => 'Calanggaman',  'latitude' => 9.9523, 'longitude' => 124.3701],
    ['name' => 'Campo',        'latitude' => 9.9567, 'longitude' => 124.3645],
    ['name' => 'Candabong',    'latitude' => 9.9489, 'longitude' => 124.3578],
    ['name' => 'Comawas',      'latitude' => 9.9601, 'longitude' => 124.3734],
    ['name' => 'Danicop',      'latitude' => 9.9412, 'longitude' => 124.3512],
    ['name' => 'Hipulon',      'latitude' => 9.9634, 'longitude' => 124.3823],
    ['name' => 'Hubangon',     'latitude' => 9.9378, 'longitude' => 124.3445],
    ['name' => 'Kampion',      'latitude' => 9.9556, 'longitude' => 124.3667],
    ['name' => 'Kanitoan',     'latitude' => 9.9489, 'longitude' => 124.3601],
    ['name' => 'Lintuan',      'latitude' => 9.9623, 'longitude' => 124.3756],
    ['name' => 'Looc',         'latitude' => 9.9401, 'longitude' => 124.3523],
    ['name' => 'Mabuhay',      'latitude' => 9.9534, 'longitude' => 124.3689],
    ['name' => 'Madangog',     'latitude' => 9.9467, 'longitude' => 124.3556],
    ['name' => 'Magsa',        'latitude' => 9.9589, 'longitude' => 124.3712],
    ['name' => 'Marawis',      'latitude' => 9.9512, 'longitude' => 124.3634],
    ['name' => 'Maubo',        'latitude' => 9.9445, 'longitude' => 124.3567],
    ['name' => 'Napo',         'latitude' => 9.9656, 'longitude' => 124.3801],
    ['name' => 'New Bohol',    'latitude' => 9.9389, 'longitude' => 124.3478],
    ['name' => 'Poblacion',    'latitude' => 9.9545, 'longitude' => 124.3656],
    ['name' => 'Soom',         'latitude' => 9.9601, 'longitude' => 124.3745],
    ['name' => 'Tagbuane',     'latitude' => 9.9423, 'longitude' => 124.3534],
    ['name' => 'Tubod',        'latitude' => 9.9578, 'longitude' => 124.3723],
    ['name' => 'Ubujan',       'latitude' => 9.9467, 'longitude' => 124.3590],
];
